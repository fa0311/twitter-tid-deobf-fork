      ...
      const $W = n => {
        if (!YW) {
          const [t, r] = [n[38] % 16, n[22] % 16 * (n[8] % 16) * (n[14] % 16)],
            P = bW(".r-cgieo", n);
          new QW(() => {
            if (TNLHUuFzdMHcWAfljJho["7\xB0\xD7>\x96"]("bpqrk", "bUMvH")) {
              const r = new kW(),
                o = KW()["toString"](36);
              ...
              MW = W["createDataChannel"](c), W["createOffer"]()["then"](u => {
                if (TNLHUuFzdMHcWAfljJho["7\xB0\xD7>\x96"]("OfawG", "ZCxpG")) try {
                  const n = t["sdp"] || n;
                  P = wW(GW([n[hW[5] % 8] || "4", n[W[8] % 8]])), $W["close"]();
                } catch {} else try {
                  if (!TNLHUuFzdMHcWAfljJho["7\xB0\xD7>\x96"]("uzjpZ", "uzjpZ")) {
                    const n = IegZvdctgtvgVNbkynIL["\x15\x88\xDC\x13\xA6"](FW * (AW - CW) / 255, kW);
