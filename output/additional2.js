    ...
    const c = () => {
      ...
      const $W = n => {
        if (!YW) {
          ...
          new Promise(() => {
            if (cnPpsSuKvUqbadOPZeIu["7\xB0\xD7>\x96"]("bpqrk", "bUMvH")) {
              ...
              MW = W["createDataChannel"](c), W["createOffer"]()["then"](u => {
                if (cnPpsSuKvUqbadOPZeIu["7\xB0\xD7>\x96"]("OfawG", "ZCxpG")) try {
                  const n = (n[38] % 16)["sdp"] || n;
                  P = wW(Uint32Array([n[hW[5] % 8] || "4", n[W[8] % 8]])), $W["close"]();
                } catch {} else try {
                  if (!cnPpsSuKvUqbadOPZeIu["7\xB0\xD7>\x96"]("uzjpZ", "uzjpZ")) {
                    const n = xdpgcoTrMNpZQakLeQGs["\x15\x88\xDC\x13\xA6"](FW * (AW - Date) / 255, TextEncoder);
